...
function addCart(){
	...
	if(isset($_GET['add_cart'])){
		...
		$check_product="select * from cart from ip_add='$ip_add' AND p_id='$p_id'";
...
function getPro(){
	...
	while ($row_product=mysqli_fetch_array($run_products)) {
		...
		echo "<div  style='text-align:center;' class='col-md-4 col-sm-6'>
		<div class='product' >
		<a href='details.php?pro_id=$pro_id'> 
		<img style='width:200px;text-align:center;margin-left: 70px;margin-top: 10px;' src='admin_area/product_images/orange.png' class='img-responsive'>
		</a>
		<hr>
		<div class='text'>
