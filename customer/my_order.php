<div class="box">
	...
	<p>if you have any questions, please feel free to <a href="../contactus.php">contact us</a>, our customer service is working for you 24/7</p>
</center>	
<hr>
	...
	<table class="table table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="confirm.php?order_id=<?php echo $order_id ?>" target="_self" class="btn btn-primary btn-sm"> Confirm If Paid</a></td>
			</tr>
		<?php } ?>
		</tbody>
	</table>
